...
<div class="management" id="shop-search">
    <h3><spring:message code="label.shop.search.management"/>
        <a data-permission="shop:toAdd" href='<c:url value="/shop/toAdd"/>' class="btn btn-primary dialog" data-width="800" data-reload-btn="a.search-btn" data-title='<spring:message code="label.shop.add.management"/>'>
            <i class="glyphicon glyphicon-plus"></i><spring:message code="label.button.add"/>
        </a>
    </h3>
    <c:url var="url" value="/shop/list"/>
    <form:form modelAttribute="shopListVO" id="commonSearchForm" method="post" class="form-inline" action="${url}">
    <div class="row">
      <div class="col-sm-12">
