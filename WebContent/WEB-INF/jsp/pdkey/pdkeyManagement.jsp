...
<div class="management" id="pdKey-search">
    <h3><spring:message code="label.pdkey.search.management"/>
        <a data-permission="pdkey:toAdd" href='<c:url value="/pdkey/toAdd"/>' class="btn btn-primary dialog" data-title='<spring:message code="label.pdkey.add.management"/>'>
            <i class="glyphicon glyphicon-plus"></i><spring:message code="label.button.add"/>
        </a>
    </h3>
    <c:url var="url" value="/pdkey/list"/>
    <form:form modelAttribute="pdKeyListVO" id="commonSearchForm" method="post" class="form-inline" action="${url}">
   <div class="row">
     <div class="col-sm-12">
      <div class="col-lg-3 col-sm-6">
		...
		<div class="col-lg-3 col-sm-6">
          <div class="form-group col-md-12"><label class="control-label">
		...
		<div class="col-lg-3 col-sm-6">
          <div class="form-group col-md-12"><label class="control-label"><spring:message code="label.isactive"/></label> <form:select path="isActive" id="isActive" class="selectpicker form-control">
