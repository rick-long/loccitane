...
<c:url var="url" value="/pdkey/edit"/>
<form:form modelAttribute="pdKeyEditVO" id="defaultForm" method="post" class="form-horizontal" action='${url }'>
    <form:hidden path="id"/>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-5">
            <div class="select-category" data-selectable="category" data-category-id="${pdKeyEditVO.categoryId }"></div>
        </div>
    </div>
    <div class="form-group">
