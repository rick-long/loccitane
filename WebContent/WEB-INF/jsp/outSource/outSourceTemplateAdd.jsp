...
<div>
    <form method="post" class="form-horizontal" data-form-token="${TokenUtil.get(pageContext)}" enctype="multipart/form-data">
    ...
    $(document).ready(function () {
        ...
        nextBtn.click(function () {
            ...
            if (currentStep.hasClass('baseStep')) {
                ...
                $.ajax({
                    url: '<c:url value="/outSource/outSourceTemplateConfirm"/>',
                    type: 'POST',
                    data: formData,
                    async: false,
