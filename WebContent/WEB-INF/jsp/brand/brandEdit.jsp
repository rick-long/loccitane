...
<c:url var="url" value="/brand/edit"/>
<form:form modelAttribute="brandEditVO" id="defaultForm" method="post" class="form-horizontal" action='${url }'>
    <form:hidden path="id"/>
    ...
    <div class="form-group">
        <label class="col-lg-4 control-label"><spring:message code="label.product.for.cash.package"/>*</label>
        <div class="col-lg-5">
            <form:select class="selectpicker form-control" path="forCashPackage" id="forCashPackage">
