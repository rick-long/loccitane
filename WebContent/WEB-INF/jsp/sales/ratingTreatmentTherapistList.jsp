...
<div class="home-shop">
	<div class="left grade">
		<div class="top">
			...
			<span><spring:message code="label.sales.staffstaravg"/> </span>
		</div>
		<canvas id="canvas" width="210" height="210" data-bg="#FFA829" data-score="${staffStarAvg}"></canvas>
...
<div class="home-shop rat-content">
	<ul>
		<li class="rat-title">
			...
			<p class="rat-cus"><spring:message code="label.sales.staffstarrating"/> </p>
		</li>
		<c:forEach items="${top10List}" var="treatmentTherapist">
		<li>
			<a href="/?loadingUrl=/review/ratingTreatmentTherapistDetails?staffId=${treatmentTherapist.staffId}">
				<span class="type-name">${treatmentTherapist.staffName}</span>
