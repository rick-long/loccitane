...
<form action="${url}" data-form-token="${TokenUtil.get(pageContext)}" method="post" class="form-horizontal">
	<input type="hidden" name="id" value="${commissionRule.id}">
    <div id="baseStep" class="baseStep step active">
        <div class="form-group">
            ...
            <div class="col-lg-5">
                ...
                <input type="hidden" name="commissionTemplateId" value="${commissionRule.commissionTemplate.id}"/>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-lg-5">
                <textarea id="description" name="description" class="form-control">${commissionRule.description}</textarea>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-5">
                <select class="selectpicker form-control" name="active" id="isActive">
                    <option value="true" <c:if test="${commissionRule.isActive == true}">selected</c:if>><spring:message code="label.option.yes"/></option>
                    <option value="false" <c:if test="${commissionRule.isActive == false}">selected</c:if>><spring:message code="label.option.no"/></option>
                </select>
            </div>
        </div>
        <%--<div class="form-group">
            ...
            <div class="col-lg-5">
                <input type="checkbox" name="calTarget" ${calTarget ? "checked" : ""}/>
            </div>
        </div>--%>
