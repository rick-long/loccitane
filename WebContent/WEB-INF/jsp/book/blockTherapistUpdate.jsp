...
<div id="blockAddContext">
    ...
    <form action="${url}" data-form-token="${TokenUtil.get(pageContext)}" method="post" class="form-horizontal">
        ...
        <input type="hidden" name="updateType" value="${blockVO.updateType}" />
        ...
        <div id="baseStep" class="baseStep step active">
            ...
            <c:choose>
                <c:when test="${block.notRepeat && isAllDay}">
                ...
                <c:otherwise>
                    <div id="startTimeField" class="form-group">
                        ...
                        <div class="col-lg-5">
                            <div class="input-group date form_time">
                                <input id="repeatStartTime" name="repeatStartTime" class="form-control" value='${blockVO.repeatStartTime}' readonly>
                                <span class="input-group-addon time-toggle"><span class="glyphicon glyphicon-time"></span></span>
                            </div>
                        </div>
                    </div>
                    <div id="endTimeField" class="form-group">
                        ...
                        <div class="col-lg-5">
                            <div class="input-group date form_time">
                                <input id="repeatEndTime" name="repeatEndTime" class="form-control" value='${blockVO.repeatEndTime}' readonly>
                                <span class="input-group-addon time-toggle"><span class="glyphicon glyphicon-time"></span></span>
                            </div>
                        </div>
                    </div>
