...
<style>
    ...
    span.glyphicon.glyphicon-pencil.walkInGuest{
        width:76px;
    }
    .client{
        position:relative;
...
<c:url var="url" value="/book/bookQuickAdd"/>
    ...
    <div id="baseStep" class="baseStep step active">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-5 client">
                ...
                <a id="clientView" data-permission="book:clientView" onclick="clientView()"  title='<spring:message code="label.button.view"/>' class="btn btn-primary dialog btn-edit" data-reload-btn="a.search-btn" data-width="950" data-title='<spring:message code="label.button.view"/>' style="display: inline;position:absolute;top:2px;right:-8px;">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#fullName', Dialog.getContext()).change(function () {
            if ($(this).val() == 'GUEST') {
