                ...
                <tr id="firstBookItem" data-bundle-id="">
                    <td>
                       <%-- <div class="select-category" data-selectable="option" data-root-id="2" data-root-id1="4"></div>--%>
                        ...
                        <input type="text" name="code"  class="form-control quick-search"/>
                    </td>
...
<table id="bookItemTemplate" class="hide">
    <tr data-bundle-id="">
        <td>
            <div class="select-category" data-selectable="option" data-root-id="2" data-root-id1="4" data-value="">
            </div>
        </td>
        <td>
            <select class="selectpicker form-control guestAmount">
        ...
        $('#next', Dialog.getContext()).click(function () {
            ...
            if (currentStep.hasClass('baseStep')) {
                ...
                $("#bookItems tbody", getContext()).find('tr').each(function (index, item) {
                    ...
                    html.push(String.format('<input type="hidden" name="bookItemVOs[{0}].productOptionId" value="{1}"/>', index, $this.find('#productOptionId').val()));
                    ...
                    if (bundleId == '') {
                        ...
                        html.push(String.format('<input type="hidden" name="bookItemVOs[{0}].productId" value="{1}"/>', index, dp.data('product-id')));
                    } else {
                        html.push(String.format('<input type="hidden" name="bookItemVOs[{0}].duration" value="{1}"/>', index, $this.find('#duration').val()));
