...
<div class="row new-row-width">
    <label><spring:message code="lable.bonus.rule.attribute"/> </label>
    <table class="table table-striped">
        ...
        <c:forEach items="${bonusRuleVO.bonusAttributeVOs}" var="item">
            <tr>
                ...
                <td>
                    <input type="text" class="form-control attributeKeys" data-attribute-key-id="${item.bonusAttributeKeyId}" 
