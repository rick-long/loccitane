...
<form action="${url}" data-form-token="${TokenUtil.get(pageContext)}" method="post" class="form-horizontal">
    <div id="baseStep" class="baseStep step active">
        <div class="form-group">
            ...
            <div class="col-lg-8">
                <select id="bonusTemplateId" name="bonusTemplateId" class="selectpicker form-control">
                </select>
            </div>
        </div>
        <div class="form-group">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        // bonus template
        $.post('<c:url value="/bonus/bonusTemplateSelectList"/>', {shopId: $(this).val()}, function (res) {
            $('#bonusTemplateId', Dialog.getContext()).html(res);
        });
