    ...
    $(function () {
        ...
        $('#next', Dialog.getContext()).click(function () {
            ...
            if (currentStep.hasClass('baseStep')) {
                ...
                $.post('<c:url value="/hairsalon/addPdkeyAndPokey"/>', form.serialize(), function (res) {
                    nextStep.html(res);
                ...
                $.post('<c:url value="/hairsalon/hairsalonConfirm"/>', form.serialize(), function (res) {
                    nextStep.html(res);
                    currentStep.removeClass('active');
                    nextStep.addClass('active');
        ...
        $('#submit', Dialog.getContext()).click(function () {
            var form = $('form', Dialog.getContext());
            $.post('<c:url value="/hairsalon/add"/>', form.serialize(), function (res) {
