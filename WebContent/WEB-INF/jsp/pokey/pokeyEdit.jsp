...
<c:url var="url" value="/pokey/edit"/>
<form:form modelAttribute="poKeyEditVO" id="defaultForm" method="post" class="form-horizontal" action='${url }'>
    <form:hidden path="id"/>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-5">
            <div class="select-category" data-selectable="category" data-category-id="${poKeyEditVO.categoryId }"></div>
        </div>
    </div>
    <div class="form-group">
