...
<div class="management" id="userlevel-search">
    <h3><spring:message code="label.user.group.search.management"/>
        <a data-permission="member:toUserGroupAdd" href='<c:url value="/member/toUserGroupAdd"/>' class="btn btn-primary dialog" data-draggable="true"
                data-title='<spring:message code="label.user.group.add.management"/>'>
            <i class="glyphicon glyphicon-plus"></i><spring:message code="label.button.add"/>
        </a>
    </h3>
    <c:url var="url" value="/member/userGroupList"/>
