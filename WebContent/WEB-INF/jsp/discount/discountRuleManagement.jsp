...
<div class="management">
    <h3>
        <spring:message code="label.discount.rule.search.management"/>
        <a data-permission="discount:discountRuleToAdd" href='<c:url value="/discount/discountRuleToAdd"/>' class="btn btn-primary dialog" data-width="680" data-reload-btn="a.search-btn" data-title='<spring:message code="label.discount.rule.add.management"/>'>
            <i class="glyphicon glyphicon-plus"></i><spring:message code="label.button.add"/>
        </a>
    </h3>
    <c:url var="url" value="/discount/discountRuleList"/>
    <form:form id="commonSearchForm" modelAttribute="discountRuleListVO" method="post" class="form-inline" action="${url}">
    <div class="row">
      <div class="col-sm-12">
	 ...
	 <div class="col-lg-3 col-sm-6">
      ...
      <div class="col-lg-3 col-sm-6">
          <div class="form-group col-md-12"><label class="control-label"><spring:message code="label.description"/></label>
