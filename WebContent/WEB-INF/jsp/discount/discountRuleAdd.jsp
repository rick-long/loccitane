...
<style>
    #discountRuleAddForm .ms-container {
        width: 350px;
    }
</style>

<c:url var="url" value="/discount/discountRuleSave"/>
<form id="discountRuleAddForm" action="${url}" data-form-token="${TokenUtil.get(pageContext)}" method="post" class="form-horizontal">
    <div id="baseStep" class="baseStep step active">

        <div class="form-group">
            <label for="discountTemplateId" class="col-lg-4 control-label">
                <spring:message code="label.template"/>*</label>
            <div class="col-lg-5">
                <select id="discountTemplateId" name="discountTemplateId" class="selectpicker form-control">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-5">
                <div class="input-group date form_time">
                    <input id="startTime" name="startTime" class="form-control appointmentDate" value='<fmt:formatDate value="${discountRuleVO.startTime}" pattern="yyyy-MM-dd"/>' size="16" readonly>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-5">
                <div class="input-group date form_time">
                    <input id="endTime" name="endTime" class="form-control appointmentDate" value='<fmt:formatDate value="${discountRuleVO.endTime}" pattern="yyyy-MM-dd"/>' size="16" readonly>
                    <span class="input-group-addon time-toggle"><span class="glyphicon glyphicon-calendar"></span></span>
                </div>
            </div>
        </div>
		...
		<div class="form-group">
            <label class="col-lg-4 control-label"><spring:message code="label.discount.loyalty.group"/> </label>
            <div class="col-lg-5">
                <div class="input-group">
