...
<div>
    <form:form method="post" modelAttribute="discountTemplateVO" class="form-horizontal" enctype="multipart/form-data">
        <form:hidden path="id"/>
        <div id="baseStep" class="baseStep step active">
            <div class="form-group">
                ...
                <div class="col-lg-5">
                    <input type="text" id="name" name="name" value="${discountTemplate.name}" class="form-control">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-lg-5">
                    <textarea id="description" name="description" class="form-control">${discountTemplate.description}</textarea>
                </div>
            </div>
            <div class="form-group">
                <label for="content" class="col-lg-4 control-label"><spring:message code="label.content"/>*</label>
                <div class="col-lg-5">
                    <textarea id="content" name="content" class="form-control">${discountTemplate.content}</textarea>
                </div>
            </div>
            ...
            <div class="row new-row-width">
                ...
                <table class="table table-striped">
                    ...
                    <tbody id="body">
                    <c:forEach items="${discountTemplate.discountAttributeKeys}" var="item" varStatus="status">
                        <tr>
                            <td>
                            ...
                            <td>
                                <button type="button" class='btn btn-warning removePOBtn<c:if test="${status.first}"> hide</c:if>'>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        submitBtn.click(function () {
            var formData = new FormData($('form', Dialog.getContext())[0]);
            $.ajax({
