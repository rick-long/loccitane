...
<div class="management" id="loyalty-search">
    <h3>
    	<spring:message code="label.loyalty.level.search.management"/>
    	<a href='<c:url value="/loyalty/toAdd"/>' class="btn btn-primary dialog" data-draggable="true" data-title='<spring:message code="label.loyalty.level.add.management"/>'>
            <i class="glyphicon glyphicon-plus"></i><spring:message code="label.button.add"/>
        </a>
    </h3>
    <c:url var="url" value="/loyalty/list"/>
    <form:form modelAttribute="loyaltyLevelListVO" id="commonSearchForm" method="post" class="form-inline" action="${url}">
    <div class="row">
      <div class="col-sm-12">
