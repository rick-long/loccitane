...
<c:url var="url" value="/awardRedemption/add"/>
...
<%--    <div class="form-group">
        ...
        <div class="col-lg-5">
            <div class="input-group date form_time">
	        	<input id=startDate name="startDate" class="form-control startDate" 
	        		value='<fmt:formatDate value="${startDate}" pattern="yyyy-MM-dd"/>' size="16">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-5">
            <div class="input-group date form_time">
                <input id="endDate" name="endDate" class="form-control endDate" size="16">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-5">
            <textarea id="validAt" name="validAt" class="form-control"></textarea>
        </div>
    </div>
    <%--<div class="form-group">
