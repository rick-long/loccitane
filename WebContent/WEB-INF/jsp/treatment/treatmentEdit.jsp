    ...
    <div id="baseStep" class="baseStep step active">
        <fieldset>
            ...
            <div class="form-group categoryTreeMenu">
			    ...
			    <div class="col-lg-5">
			       	<div class="select-category" data-selectable="category" data-category-id="${productEditVO.categoryId }" data-root-id="2"></div>
				</div>
		    </div>
		    <div class="form-group">
		        <label class="col-lg-4 control-label">Show Online</label>
		        <div class="col-lg-5">
    ...
    $(function () {
        ...
        $('#next', Dialog.getContext()).click(function () {
            ...
            if (currentStep.hasClass('baseStep')) {
                ...
                $.post('<c:url value="/treatment/editPdkeyAndPokey"/>', form.serialize(), function (res) {
                    nextStep.html(res);
                ...
                $.post('<c:url value="/treatment/editConfirm"/>', form.serialize(), function (res) {
                    nextStep.html(res);
                    currentStep.removeClass('active');
                    nextStep.addClass('active');
        ...
        $('#submit', Dialog.getContext()).click(function () {
            var form = $('form', Dialog.getContext());
            $.post('<c:url value="/treatment/edit"/>', form.serialize(), function (json) {
                ...
                if(json['statusCode'] === 300){
                    Dialog.alert('<spring:message code="label.remove.product.option"/>');
                }
            });
        });
