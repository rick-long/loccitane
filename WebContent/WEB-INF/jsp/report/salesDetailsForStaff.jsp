...
<div class="management container" id="sales-details">
    <c:url var="url" value="/report/listSalesDetailsForStaff"/>
    <form:form modelAttribute="salesSearchVO" id="commonSearchForm" method="post" class="form-inline" action="${url}">
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="form-group col-md-12"><label class="control-label"><spring:message
                            code="label.member.product.type"/> </label>
            ...
            <div class="col-sm-12">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="form-group col-md-12">
                        <a data-permission="report:toSalesDetailsForStaff" href="javascript:;"
                           onclick='exportSearchForm(this,"<c:url value="/report/salesDetailsForStaffExport?"/>");'
