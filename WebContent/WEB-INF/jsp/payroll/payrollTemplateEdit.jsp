...
<div>
    <form:form method="post" modelAttribute="payrollTemplateVO" class="form-horizontal" enctype="multipart/form-data">
        <form:hidden path="id"/>
        <div class="form-group">
            <label for="name" class="col-lg-4 control-label"><spring:message code="label.name"/></label>
            <div class="col-lg-5">
                <input type="text" id="name" name="name" value="${payrollTemplate.name}" class="form-control">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-lg-5">
                <textarea id="description" name="description" class="form-control">${payrollTemplate.description}</textarea>
            </div>
        </div>
        <div class="form-group">
            <label for="content" class="col-lg-4 control-label"><spring:message code="label.content"/></label>
            <div class="col-lg-5">
                <textarea id="content" name="content" class="form-control">${payrollTemplate.content}</textarea>
            </div>
        </div>
        <div class="row new-row-width">
             ...
             <table class="table table-striped">
                 ...
                 <tbody id="body">
                 <c:forEach items="${payrollTemplate.payrollAttributeKeys}" var="item" varStatus="status">
                     <tr>
                         <td>
                         ...
                         <td>
                             <input type="text" class="form-control displayOrder" value="${item.displayOrder}"/>
                         </td>
                         <td>
