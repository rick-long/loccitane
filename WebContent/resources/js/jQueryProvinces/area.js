var provinceList = [
    ...
    {name:'上海', cityList:[
        {name:'市辖区', areaList:['黄浦区','徐汇区','长宁区','静安区','普陀区','虹口区','杨浦区','闵行区','宝山区','嘉定区','浦东新区','金山区','松江区','青浦区','奉贤区']},
        {name:'县', areaList:['崇明县']}
    ]},
    {name:'天津', cityList:[
        {name:'市辖区', areaList:['和平区','河东区','河西区','南开区','河北区','红桥区','东丽区','西青区','津南区','北辰区','武清区','宝坻区','滨海新区','宁河区','静海区']},
        {name:'县', areaList:['蓟　县']}
    ]},
    {name:'重庆', cityList:[
        {name:'市辖区', areaList:['万州区','涪陵区','渝中区','大渡口区','江北区','沙坪坝区','九龙坡区','南岸区','北碚区','綦江区','渝北区','巴南区','巴南区','黔江区','长寿区','长寿区','江津区','合川区','永川区','南川区','璧山区','铜梁区','潼南区','荣昌区']},
        {name:'县', areaList:['梁平县','城口县','垫江县','武隆县','忠县','开县','云阳县','巫山县','巫溪县','石柱土家族自治县','秀山土家族苗族自治县','酉阳土家族苗族自治县','彭水苗族土家族自治县']},
        {name:'市', areaList:['江津市','合川市','永川市','南川市']}
    ]},
    {name:'广东', cityList:[
        {name:'广州市', areaList:['荔湾区','越秀区','海珠区','天河区','白云区','黄埔区','南沙区','番禺区','花都区','增城区','从化区']},
    ...
    {name:'湖南', cityList:[
        ...
        {name:'永州市', areaList:['零陵区','冷水滩区','祁阳县','东安县','双牌县','道　县','江永县','宁远县','蓝山县','新田县','江华瑶族自治县']},
    ...
    {name:'河北', cityList:[
        {name:'石家庄市', areaList:['长安区','桥西区','新华区','井陉矿区','裕华区','藁城区','鹿泉区','栾城县','井陉县','正定县','行唐县','灵寿县','高邑县','深泽县','赞皇县','无极县','平山县','元氏县','赵 县','辛集市','晋州市','新乐市']},
        {name:'唐山市', areaList:['路南区','路北区','古冶区','开平区','丰南区','丰润区','曹妃甸区','滦 县','滦南县','乐亭县','迁西县','玉田县','遵化市','迁安市']},
        ...
        {name:'保定市', areaList:['竞秀区','莲池区','满城区','徐水区','涞水县','阜平县','定兴县','徐水县','唐 县','高阳县','容城县','涞源县','望都县','安新县','易　县','曲阳县','蠡　县','顺平县','博野县','雄　县','涿州市','定州市','安国市','高碑店市']},
    ...
    {name:'河南', cityList:[
        ...
        {name:'开封市', areaList:['龙亭区','顺河回族区','鼓楼区','禹王台区','祥符区','杞　县','通许县','尉氏县','兰考县']},
    ...
    {name:'江苏', cityList:[
        ...
        {name:'徐州市', areaList:['鼓楼区','云龙区','贾汪区','泉山区','铜山区','丰 县','沛 县','睢宁县','新沂市','邳州市']},
        ...
        {name:'泰州市', areaList:['海陵区','姜堰区','高港区','兴化市','靖江市','泰兴市']},
    ...
    {name:'安徽', cityList:[
        ...
        {name:'马鞍山市', areaList:['花山区','雨山区','博望区','当涂县','含山县','和 县']},
        {name:'淮北市', areaList:['杜集区','相山区','烈山区','濉溪县']},
        {name:'铜陵市', areaList:['铜官区','义安区','郊　区','枞阳县']},
    ...
    {name:'江西', cityList:[
        {name:'南昌市', areaList:['东湖区','西湖区','青云谱区','湾里区','青山湖区','新建区','南昌县','安义县','进贤县']},
        ...
        {name:'赣州市', areaList:['章贡区','南康区','赣　县','信丰县','大余县','上犹县','崇义县','安远县','龙南县','定南县','全南县','宁都县','于都县','兴国县','会昌县','寻乌县','石城县','瑞金市']},
    ...
    {name:'山东', cityList:[
        ...
        {name:'济宁市', areaList:['任城区','兖州区','微山县','鱼台县','金乡县','嘉祥县','汶上县','泗水县','梁山县','曲阜市','兖州市','邹城市']},
    ...
    {name:'黑龙江', cityList:[
        {name:'哈尔滨市', areaList:['道里区','南岗区','道外区','平房区','松北区','香坊区','呼兰区','阿城区','双城区','依兰县','方正县','宾 县','巴彦县','木兰县','通河县','延寿县','尚志市','五常市']},
        ...
        {name:'大兴安岭地区', areaList:['加格达奇区','呼玛县','塔河县','漠河县']}
    ]},
    {name:'四川', cityList:[
        ...
        {name:'宜宾市', areaList:['翠屏区','南溪区','宜宾县','江安县','长宁县','高　县','珙　县','筠连县','兴文县','屏山县']},
        {name:'广安市', areaList:['广安区','前锋区','岳池县','武胜县','邻水县','华莹市']},
        {name:'达州市', areaList:['通川区','达川区','宣汉县','开江县','大竹县','渠　县','万源市']},
    ...
    {name:'西藏', cityList:[
        {name:'拉萨市', areaList:['城关区','堆龙德庆县','林周县','当雄县','尼木县','曲水县','达孜县','墨竹工卡县']},
    ...
    {name:'青海', cityList:[
        ...
        {name:'海东市', areaList:['乐都区','平安县','民和回族土族自治县','互助土族自治县','化隆回族自治县','循化撒拉族自治县']},
        ...
        {name:'海西蒙古族藏族自治州', areaList:['格尔木市','德令哈市','乌兰县','都兰县','天峻县','海西蒙古族藏族自治州直辖']}
    ]},
    {name:'宁夏', cityList:[
    ...
    {name:'海南', cityList:[
        ...
        {name:'三亚市', areaList:['三亚湾','海棠区','吉阳区','天涯区','崖州区']},
    ...
    {name:'香港', cityList:[
        {name:'香港特别行政区', areaList:['中西区','湾仔区','东区','南区','油尖旺区','深水埗区','九龙城区','黄大仙区','观塘区','荃湾区','屯门区','元朗区','北区','大埔区','西贡区','沙田区','葵青区','离岛区']}

    ]},
    {name:'澳门', cityList:[
        {name:'澳门特别行政区', areaList:['花地玛堂区','花王堂区','望德堂区','大堂区','风顺堂区','嘉模堂区','路凼填海区','圣方济各堂区']}
    ]},
    {name:'台湾', cityList:[
