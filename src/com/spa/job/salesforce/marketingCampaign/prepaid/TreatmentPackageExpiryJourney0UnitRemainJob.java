...
public class TreatmentPackageExpiryJourney0UnitRemainJob extends OpenSessionQuartzJobBean {
	
    private static final String marketing_campaign_code="7";
    private static final String marketing_campaign_subCode="tpr0";
    private static final String marketing_campaign_subCode_backup="-tpr0";
    private static final Integer remain_units=0;
    ...
    protected void executeJob(JobExecutionContext ctx) throws JobExecutionException {
        String loginUser ="TreatmentPackageExpiryJourney0UnitRemainJob";
        ...
        if(prevUmps !=null && prevUmps.size()>0){
            System.out.println(" run ----TreatmentPackageExpiryJourney0UnitRemainJob---  prev id size ----"+prevUmps.size());
        ...
        if(postIds !=null && postIds.size()>0){
        	System.out.println(" run ----TreatmentPackageExpiryJourney0UnitRemainJob---  postIds id size ----"+postIds.size());
            User postUser =null;
