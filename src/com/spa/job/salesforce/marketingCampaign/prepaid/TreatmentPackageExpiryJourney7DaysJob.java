...
public class TreatmentPackageExpiryJourney7DaysJob extends OpenSessionQuartzJobBean {

    private static final Long marketing_campaign_id = 10L;//#7tpe7
    ...
    protected void executeJob(JobExecutionContext ctx) throws JobExecutionException {
        String loginUser ="TreatmentPackageExpiryJourney7DaysJob";
        ...
        if(prevUmps !=null && prevUmps.size()>0){
            System.out.println(" run ----TreatmentPackageExpiryJourney7DaysJob---  prev id size ----"+prevUmps.size());
        ...
        System.out.println(" run ----TreatmentPackageExpiryJourney7DaysJob---end--");
