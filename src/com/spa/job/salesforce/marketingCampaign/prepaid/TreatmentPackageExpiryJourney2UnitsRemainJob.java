...
public class TreatmentPackageExpiryJourney2UnitsRemainJob extends OpenSessionQuartzJobBean {

	private static final String marketing_campaign_code="7";
    private static final String marketing_campaign_subCode="tpr2";
    private static final String marketing_campaign_subCode_backup="-tpr2";
    private static final Integer remain_units=2;
    ...
    protected void executeJob(JobExecutionContext ctx) throws JobExecutionException {
    	 String loginUser ="TreatmentPackageExpiryJourney2UnitsRemainJob";
         ...
         if(prevUmps !=null && prevUmps.size()>0){
             System.out.println(" run ----TreatmentPackageExpiryJourney2UnitsRemainJob---  prev id size ----"+prevUmps.size());
         ...
         if(postIds !=null && postIds.size()>0){
         	System.out.println(" run ----TreatmentPackageExpiryJourney2UnitsRemainJob---  postIds id size ----"+postIds.size());
             User postUser =null;
         ...
         System.out.println(" run ----TreatmentPackageExpiryJourney2UnitsRemainJob---end--");
