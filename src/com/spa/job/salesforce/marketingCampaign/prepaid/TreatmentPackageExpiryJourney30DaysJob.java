...
public class TreatmentPackageExpiryJourney30DaysJob extends OpenSessionQuartzJobBean {

    private static final Long marketing_campaign_id = 9L;//#7tpe30
    ...
    protected void executeJob(JobExecutionContext ctx) throws JobExecutionException {
        String loginUser ="TreatmentPackageExpiryJourney30DaysJob";
        ...
        if(prevUmps !=null && prevUmps.size()>0){
            System.out.println(" run ----TreatmentPackageExpiryJourney30DaysJob---  prev id size ----"+prevUmps.size());
        ...
        System.out.println(" run ----TreatmentPackageExpiryJourney30DaysJob---end--");
